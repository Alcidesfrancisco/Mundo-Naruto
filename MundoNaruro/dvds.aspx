<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true"
    CodeBehind="dvds.aspx.cs" Inherits="MundoNaruro.dvds" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
    <br />
    <asp:Label ID="dvdsLabel" runat="server" Text="DVDs Mundo Naruto"></asp:Label>
    <br />
    <br />
    <br />
    <asp:Panel ID="Panel1" runat="server" Style="margin-bottom: 244px" ScrollBars="Both">
        <div style="position: static; width: 805px; height: 750px; top: 81px; left: -1px;
            ...
            <%
                ...
                ArrayList dvds = produtoDAO.listarDVDs();
                foreach (ProdutoBean item in dvds)
                {
