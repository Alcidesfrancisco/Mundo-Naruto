<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Bones.aspx.cs" Inherits="MundoNaruro.Bone" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"
    ...
    <br />
    <br />
    <asp:Label ID="CamisasLabel" runat="server" Text="Bonés Mundo Naruto"></asp:Label>
    <br />
    <br />
    <br />
    <asp:Panel ID="Panel1" runat="server" Style="margin-bottom: 244px" ScrollBars="Both">
        <div style="position: static; width: 805px; height: 750px; top: 81px; left: -1px;
            ...
            <%
                ...
                ArrayList camisas = produtoDAO.listarBones();
